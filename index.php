        ...
        <main class="row d-flex">
            <div class="sidebar col-3 menu">
                <ul class="w-100 menuList">
                    <li><a href="index.php" class="active"><i class="fas fa-home fa-lg mx-3"></i>Home</a></li>
                    ...
                    <li><a href="about_us.php"><i class="fas fa-info-circle fa-lg mx-3"></i>About Us</a></li>
