		...
		<main class="row d-flex mainContainer">
			...
			<div class="col-9 p-0 d-flex flex-column">
				<div class="mainContent col-12">
					<div class="callout-info row p-3 mb-3">
						<div class="col-md-10 msg d-block">
							<h5 class="fw-bold"> 12 AUG, 2021</h5>
							<p>This is a callout. We built it custom for our docs so our messages to
								you
								stand
								out.</p>
						</div>
						<div class="col-md-2 d-flex align-content-center justify-content-center">
							<div class="align-self-center ">
								<button type="button" class="btn btn-primary"><i class="fas fa-undo"></i></button>
					...
					<div class="callout-info row p-3 mb-3">
						<div class="col-md-10 msg d-block">
							<h5 class="fw-bold"> 02 JUL, 2021</h5>
							<p>This is a callout. We built it custom for our docs so our messages to
								you
								stand
								out.</p>
					...
					<div class="callout-info row p-3 mb-3">
						<div class="col-md-10 msg d-block">
							<h5 class="fw-bold"> 01 JUL, 2021</h5>
							<p>This is a callout. We built it custom for our docs so our messages to
								you
								stand
								out.</p>
					...
					<div class="callout-info row p-3 mb-3">
						<div class="col-md-10 msg d-block">
							<h5 class="fw-bold"> 29 JUN, 2021</h5>
							<p>This is a callout. We built it custom for our docs so our messages to
								you
								stand
								out.</p>
					...
					<div class="callout-info row p-3 mb-3">
						<div class="col-md-10 msg d-block">
							<h5 class="fw-bold"> 28 JUN, 2021</h5>
							<p>This is a callout. We built it custom for our docs so our messages to
								you
								stand
								out.</p>
